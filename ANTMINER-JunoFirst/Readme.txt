...
Build:
* Obtain correct roms file for Juno First (see scripts in tools folder for rom details).
* Unzip rom files to the tools folder.
* Run the make junofirst proms script in the tools folder.
* Place the generated prom files inside the proms folder.
* Open the ANTMINER-JunoFirst project file using Vivado (v2022.2 or silimar is recommended)
